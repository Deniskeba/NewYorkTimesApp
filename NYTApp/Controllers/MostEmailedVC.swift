...
class MostEmailedVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
//MARK: - request
        networkService.fetchData(url: "https://api.nytimes.com/svc/mostpopular/v2/emailed/30.json?api-key=0p0l10fitHGV5QReOPAbOxf00hWmN0Dr") { [self] (result) in
            switch result {
